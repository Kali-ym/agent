...
- 做论文方向：进入 [Paper Agent 项目蓝图](../07-项目与示例/projects/01-paper-agent/README.md)。
- 做生活/业务方向：进入 [Travel Agent 项目蓝图](../07-项目与示例/projects/02-travel-agent/README.md)。
- 做浏览器方向：进入 [Web Agent 项目蓝图](../07-项目与示例/projects/03-web-agent/README.md)。
- 做资料型项目：进入 [多模态 RAG 资源](../08-资源/multimodal/README.md)。
