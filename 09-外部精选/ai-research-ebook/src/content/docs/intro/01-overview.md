...
- 新手建议先读：[`/docs/idea/01-research`](../idea/01-research.md) → [`/docs/idea/02-projects`](../idea/02-projects.md)
- 需要快速落地：[`/docs/tools/02-workflow`](../tools/02-workflow.md) + [`/docs/review/01-structured`](../review/01-structured.md)
- 关注工程效率：[`/docs/code/01-claude`](../code/01-claude.md) + [`/docs/code/03-agents`](../code/03-agents.md)
