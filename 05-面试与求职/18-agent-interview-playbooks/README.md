...
```bash
python ../examples/resume_storytelling_check.py --mode resume
python ../examples/resume_storytelling_check.py --mode story
```
...
- [开发岗专项题](../19-development-specialized.md)
- [大厂真实面经](../12-company-interview-cases.md)
- [Agent Evaluation Harness 完全指南](../../03-技术栈/26-agent-evaluation-harness-guide.md)
- [Agent Memory 完整指南](../../03-技术栈/15-agent-memory.md)
