...
- [🧭 新手快速开始](../01-快速开始/README.md) | [🧭 2026 Agent 求职路线](../06-路线图/agent-job-ready-roadmap-2026.md) | [🛠️ Agent 项目落地方法](../04-实践指南/05-ship-agent-project.md) | [🧩 Agent Harness Engineering](../03-技术栈/27-agent-harness-engineering.md)
- [📄 Paper Agent](../07-项目与示例/projects/01-paper-agent/README.md) | [🧳 Travel Agent](../07-项目与示例/projects/02-travel-agent/README.md) | [🌐 Web Agent](../07-项目与示例/projects/03-web-agent/README.md) | [🖼️ Multimodal RAG](../08-资源/multimodal/README.md)
...
- 完整路线：[2026 Agent 求职通关路线](../06-路线图/agent-job-ready-roadmap-2026.md)
- 项目落地方法：[如何落地一个可写进简历的 Agent 项目](../04-实践指南/05-ship-agent-project.md)
- 工程核心专题：[Agent Harness Engineering](../03-技术栈/27-agent-harness-engineering.md)
...
**📖 完整技术方向详解**：[转行大模型热门方向准备指南](../05-面试与求职/06-career-transition.md)
...
**🚀 新手推荐**：
- 📘 [**AgentGuide开源学习路线（简易版）**](../06-路线图/AgentGuide开源学习路线（简易版本）.md) - **从零到Offer完整路径**，8-15周系统化学习方案，包含完整资源清单 ⭐⭐⭐
...
**👉 [查看详细路线图](../06-路线图/learning-roadmap-algorithm.md)**
...
**👉 [查看详细路线图](../06-路线图/learning-roadmap-development.md)**
...
📖 [阅读：什么是 AI Agent？](../02-理论基础/01-what-is-agent.md)
...
📖 [阅读：Agent 技术演进史](../02-理论基础/02-agent-history.md)
...
📖 [深入阅读：Transformer 架构详解](../02-理论基础/03-transformer.md)  
📖 [DeepSeek 系列完整深度笔记](../02-理论基础/10-deepseek-series.md) 🆕  
📖 [LLaMA 系列完整深度笔记](../02-理论基础/11-llama-series.md) 🆕  
📖 [Qwen 系列深度学习笔记](../02-理论基础/12-qwen-series.md) 🆕
...
📖 [实战教程：手撕 ReAct](../02-理论基础/04-react-framework.md)  
📖 [实战教程：规划与执行](../02-理论基础/05-cot-and-planning.md)
...
📖 [框架对比：如何选择？](../03-技术栈/04-langchain-guide.md)  
📖 [Multi-Agent 框架详解](../03-技术栈/06-multi-agent-frameworks.md)
...
| 框架 | 核心特性 | 适用场景 | 学习资源 |
|:-----|:---------|:---------|:---------|
| **LangGraph** | 图导向、状态管理、循环控制 | 复杂工作流、需要精确控制的场景 | [📖 完整教程](../03-技术栈/04-langchain-guide.md) |
| **AutoGen** | 多 Agent 对话、角色扮演 | 团队协作、复杂任务分解 | [📖 实战指南](../03-技术栈/06-multi-agent-frameworks.md) |
| **AgentScope** | 消息驱动、灵活扩展 | 国内场景、中文优化 | [📖 快速上手](../03-技术栈/07-agentscope.md) |
| **CrewAI** | 角色分工、层级管理 | 企业级应用、流程自动化 | [📖 企业实战](../03-技术栈/06-multi-agent-frameworks.md) |
...
📖 [实战项目：打造自己的 Agent 框架](../03-技术栈/22-build-your-agent-framework.md)
...
📖 [完整教程：RAG 系统开发指南](../03-技术栈/20-rag-full-pipeline.md)  
📖 [向量数据库选型](../03-技术栈/08-vector-db-basics.md)
...
📖 [必读：上下文工程资源合集](../03-技术栈/13-context-engineering-resources.md) 🔥  
📖 [深度指南：Context Engineering 2.0](../03-技术栈/18-context-engineering-guide.md)
...
📖 [协议详解：MCP 完全指南](../03-技术栈/28-mcp-protocol.md)
...
📖 [完整指南：Agent 强化学习](../03-技术栈/21-agent-reinforcement-learning.md)  
📖 [实战：SFT 监督微调](../03-技术栈/16-sft-finetuning.md)  
📖 [Post-Training 完整面试指南](../03-技术栈/25-post-training-complete-guide.md) 🆕
...
📖 [评估指南：科学评估 Agent](../02-理论基础/09-evaluation-metrics.md)
📖 [AgentBench 详解](../02-理论基础/08-agent-bench.md)
📖 [🔥 **AI Agent 评估完全指南** (Anthropic官方万字长文)](../03-技术栈/agent-evaluation-complete-guide.md) ⭐ **必读**
...
📖 [完整指南：高可用 RAG 系统](../04-实践指南/02-high-availability-rag.md)  
📖 [安全性指南](../04-实践指南/03-agent-security.md)
...
**包含内容**：
- [优质 Agent 实战开源项目](../07-项目与示例/projects/04-end-to-end-projects/README.md)
- [优质 Workflow 项目](../07-项目与示例/projects/05-agent-workflows/README.md)
- [优质 Agent 项目集合](../07-项目与示例/projects/06-project-collections/README.md)
...
📖 [毕业设计完整指南](../04-实践指南/04-graduation-project.md)
...
**理论基础（必学）**
- [x] [📘 LLM/VLM/RLHF理论题](../05-面试与求职/01-theory-questions.md)
...
**RAG系统（开发岗重点）**
- [x] [📊 RAG全流程题](../05-面试与求职/02-rag-questions.md)
  - **核心原理**: 检索、索引、生成
...
**Agent开发（核心）**
- [x] [🤖 Agent系统题](../05-面试与求职/03-agent-questions.md)
...
**编程实战（必备）**
- [x] [💻 手撕代码题](../05-面试与求职/04-coding-questions.md)
...
- [x] [💻 大模型手撕刷题路线](../05-面试与求职/17-coding-exercises.md) 🆕
...
- [x] [🔬 算法岗专项](../05-面试与求职/05-algorithm-specialized.md) - 算法创新/推导/实验/论文 **45题**
- [x] [🛠️ 开发岗专项](../05-面试与求职/19-development-specialized.md) - 系统设计/工程实践/选型/落地 **45题**

**🏢 真实面经与进阶**

- [x] [📋 大厂真实面经](../05-面试与求职/12-company-interview-cases.md) - 美团/字节/阿里等16个完整案例
- [x] [🧭 AI Agent 面试备战手册合集](../05-面试与求职/18-agent-interview-playbooks/README.md) - Memory、Skills、Harness、评估、数据合成、源码分析与项目话术
- [x] [📊 模型评估专题](../05-面试与求职/13-model-evaluation.md) - BLEU/ROUGE、基准测试、LLM-as-Judge **10题**
- [x] [🔮 前景与趋势](../05-面试与求职/14-llm-future-trends.md) - AGI、多模态、世界模型等开放讨论 **9题**
- [x] [💬 开放性讨论](../05-面试与求职/15-open-discussion.md) - 技术判断、学习建议、核心素质 **8题**
...
#### 求职软技能
- [x] [📝 简历编写指南](../05-面试与求职/20-resume-guide.md) - AI Agent 项目简历公式、双岗写法与自检脚本
- [x] [🎤 项目讲述技巧](../05-面试与求职/21-storytelling.md) - STAR+Tech 项目表达、追问地图与复盘模板
- [x] [⭐ 转行大模型指南](../05-面试与求职/07-career-transition.md)
- [x] [⭐ 秋招完整攻略](../05-面试与求职/08-job-hunting-guide.md)
...
#### 面试软技能（新增⭐）
- [x] [⭐ 校招生谈薪实用指南](../05-面试与求职/09-salary-negotiation.md) - 3大原则、话术模板
- [x] [⭐ HR面试完全攻略](../05-面试与求职/10-hr-interview.md) - 10大高频问题应对
- [x] [⭐ 秋招心态调整指南](../05-面试与求职/11-mindset.md) - 保持好心态拿Offer
...
**🤖 Agent 方向**：
- [x] [Agent 资源总览 📂](../08-资源/agent/README.md) - Agent 所有资源导航
  - [Agent 框架对比](../08-资源/agent/frameworks.md) - 5个核心框架
  - [Memory 模块](../08-资源/agent/memory.md) - 4个记忆系统
  - [Tool Use](../08-资源/tools.md) - 工具调用
  - GUI Agent - 界面操作 *(待创建)*
  - [核心论文](../08-资源/agent/papers/README.md) - 必读论文

**📊 RAG 方向**：
- [x] [RAG 资源总览 📂](../08-资源/rag) - RAG 所有资源导航
  - [向量数据库](../08-资源/rag/vector-db.md) - 5个核心向量库
  - [文档解析](../08-资源/rag/document-parsing.md) - 5个解析工具
  - [完整项目汇总](../08-资源/rag/projects.md) - 150+个RAG开源项目 🆕
  - Embedding 模型 - Embedding选型 *(待创建)*
  - Reranker - 重排序 *(待创建)*
  - 高级RAG - GraphRAG、HyDE *(待创建)*
  - [核心论文](../08-资源/rag/papers/README.md) - 必读论文

**🛠️ 通用工具**：
- [x] [开发者工具箱](../08-资源/tools.md) - Cursor、元宝、Excalidraw
- [x] [开发框架总览](08-资源/frameworks.md) - 快速框架对比
...
```bash
# 第一步：理解 Agent 是什么
阅读：obsidian/02-理论基础/01-what-is-agent.md

# 第二步：学习核心框架 ReAct
阅读：obsidian/02-理论基础/04-react-framework.md

# 第三步：快速上手 LangChain
阅读：obsidian/03-技术栈/04-langchain-guide.md

# 第四步：查看 Agent 示例
阅读：obsidian/07-项目与示例/examples/README.md
```
...
# 第三步：学习向量数据库
阅读：obsidian/03-技术栈/08-vector-db-basics.md

# 第四步：查看 RAG 与项目示例
阅读：obsidian/03-技术栈/20-rag-full-pipeline.md
阅读：obsidian/07-项目与示例/examples/README.md
```
...
详细贡献指南请参考：[CONTRIBUTING.md](贡献指南.md)
...
- 📊 [项目总结 (PROJECT_SUMMARY)](项目总结.md) - 项目定位与核心优势
- 🤝 [贡献指南 (CONTRIBUTING)](贡献指南.md) - 如何参与贡献

### 🗺️ 学习路线
- 🧭 [2026 Agent 求职通关路线](../06-路线图/agent-job-ready-roadmap-2026.md) - Agent Loop、Harness、Skills、Eval、项目产出的可执行路线 ⭐ 新增
- 🚀 [AgentGuide开源学习路线（简易版）](../06-路线图/AgentGuide开源学习路线（简易版本）.md) - 从零到Offer完整路径（8-15周）⭐ 新增
- 🔬 [算法岗详细路线](../06-路线图/learning-roadmap-algorithm.md) - 每日学习计划
- 🛠️ [开发岗详细路线](../06-路线图/learning-roadmap-development.md) - 每日学习计划

### 💼 实战方法
- 🛠️ [如何落地一个可写进简历的 Agent 项目](../04-实践指南/05-ship-agent-project.md) - Spec、AI 编程环境、项目理解 Skill、Eval 和消融实验
- 🧩 [Agent Harness Engineering](../03-技术栈/27-agent-harness-engineering.md) - Agent Harness 七层模型与可靠性六件套

### 📂 资源导航
- 🤖 [Agent 资源总览](../08-资源/agent/README.md) - Agent 所有资源
- 📊 [RAG 资源总览](../08-资源/rag) - RAG 所有资源
- 🛠️ [开发工具箱](../08-资源/tools.md) - 效率工具推荐
- 📚 [精选学习资源](../08-资源/learning-resources.md) - 课程、教程、书籍汇总
